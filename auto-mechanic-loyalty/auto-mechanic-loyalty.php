<?php
/**
 * Plugin Name: Auto Mechanic Loyalty - Pro Demo
 * Plugin URI:  https://github.com/Garage-loyalty/garage-loyalty
 * Description: Uitgebreide plugin met RDW-koppeling, WhatsApp inbound/outbound, AI, APK-herinnering, bandenwissels, AI per garage, koppeling inkomende berichten en monteur-flow.
 * Version: 2.91
 * Author: Jack Wullems
 * Author URI: https://github.com/Garage-loyalty
 * License: GPL2
 * GitHub Plugin URI: https://github.com/Garage-loyalty/garage-loyalty
 * GitHub Branch: main
 * GitHub Release Asset: auto-mechanic-loyalty.zip
 */
